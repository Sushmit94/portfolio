...
const App = () => {
    ...
    const about = "Passionate about technology and eager to continue growing my skills in software development, I bring a solid foundation in Python, C, C++, HTML, CSS, JavaScript, and React. I love building innovative projects that push the boundaries of technology. My journey in coding has equipped me with a diverse skill set and a problem-solving mindset, which I am excited to apply in the realms of web and app development. I believe in learning by doing and enjoy working on real-world applications that bring ideas to lifeAlways exploring the latest in tech, I’m on a mission to create impactful solutions in the decentralized world. Let’s build the future together!";
...
<br></br>
            ...
            {/* Projects Section - Original Card Style */}
